 ...
 */
public class WarmachineTournamentPlayerRankingTable {
    ...
    public static final String TABLE_WARMACHINE_TOURNAMENT_PLAYER_RANKING = "warmachine_tournament_player_ranking";
    ...
    public static void createTable(SQLiteDatabase db) {
        ...
        Log.i(WarmachineTournamentPlayerRankingTable.class.getName(), "create tournament_player table");

        db.execSQL(" CREATE TABLE " + TABLE_WARMACHINE_TOURNAMENT_PLAYER_RANKING
            + " (" + COLUMN_ID
    ...
    public static void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        db.execSQL("DROP TABLE IF EXISTS " + TABLE_WARMACHINE_TOURNAMENT_PLAYER_RANKING);
        createTable(db);
    }
}
